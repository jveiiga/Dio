...
-- Traz todos os usuario com suas reservas e seu destino
SELECT * FROM usuarios us
INNER JOIN reservas rs ON us.id = rs.id_usuario
...
-- SELECIONE tudo DE destinos (des)
-- JUNTE A ESQUERDA com reservas (rs) A PARTIR DE destinos e a coluna id_destino de reservas.
